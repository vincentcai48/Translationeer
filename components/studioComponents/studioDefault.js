  ...
  return (
    <div id="studio-default-container">
      ...
      <section className="studioDefault-section">
        <h2>Powerful.</h2>
        <p>
          Make the most of all the tools on the Translationeer platform. Fully
          integrated with all the Translationeer tools, including Translationeer
          Interactive Canvas and on the spot definition lookups
        </p>
      </section>
      <section className="studioDefault-section">
        <h2>Flexible.</h2>
        <p>
          Clearly organize your translation by splitting and merging sections of
          each document to create a translation that makes sense to you.
          Structure the studio the way you want, for an immersive and customized
          experience
        </p>
      </section>
      ...
      {pAuth.currentUser ? (
        ...
        <section className="studioDefault-section">
          <h2>Get Started</h2>
          <p>Login With Google to go use the Translationeer Studio</p>
