      ...
      <div id="studio-default-container">
        ...
        <section className="studioDefault-section">
          ...
          <p>
            ...
            integrated with all the Translationeer tools, including
            Translationeer Interactive Canvas and on the spot definition lookups
          </p>
        </section>
        <section className="studioDefault-section">
          <h2>Flexible.</h2>
          <p>
            Clearly organize your translation by splitting and merging sections
            of each document to create a translation that makes sense to you.
            Structure the studio the way you want, for an immersive and
