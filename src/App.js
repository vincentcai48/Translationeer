...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    pFirestore.collection('settings').doc('termsandconditions').get().then((doc)=>{
  ...
  cancelNewUser = () => {
    pAuth.currentUser.delete().then(this.setState({newUser: null})).catch(e=>console.log(e))
  }
  ...
  render() {
    ...
    if(this.state.newUser) return <NewUser registerNewUser={this.registerNewUser} user={this.state.newUser} cancelFunction={this.cancelNewUser} tc={this.state.tc}/>
    return (
